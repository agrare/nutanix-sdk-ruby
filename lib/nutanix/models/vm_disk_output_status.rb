...
module Nutanix
  ...
  class VmDiskOutputStatus
    ...
    def self.openapi_types
      {
        :'uuid' => :'String',
        :'is_encryption_in_progress' => :'Boolean',
        ...
        :'data_source_reference' => :'VmDiskOutputStatusDataSourceReference',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::VmDiskOutputStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::VmDiskOutputStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_encryption_in_progress')
        self.is_encryption_in_progress = attributes[:'is_encryption_in_progress']
      else
        self.is_encryption_in_progress = false
      end

      if attributes.key?(:'is_migration_in_progress')
        self.is_migration_in_progress = attributes[:'is_migration_in_progress']
      else
        self.is_migration_in_progress = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          uuid == o.uuid &&
          is_encryption_in_progress == o.is_encryption_in_progress &&
    ...
    def hash
      [uuid, is_encryption_in_progress, is_migration_in_progress, disk_size_bytes, storage_config, device_properties, data_source_reference, disk_size_mib, volume_group_reference].hash
    end
