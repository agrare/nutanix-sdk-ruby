...
module Nutanix
  # Action template object for example action templates.
  class ActionTemplateResources
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::ActionTemplateResources` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::ActionTemplateResources`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'blank_template')
        self.blank_template = attributes[:'blank_template']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          blank_template == o.blank_template
    end
    ...
    def hash
      [action_type_reference, display_name, description, is_disabled, input_parameter_values, blank_template].hash
    end
