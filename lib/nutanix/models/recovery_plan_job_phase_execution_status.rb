...
module Nutanix
  ...
  class RecoveryPlanJobPhaseExecutionStatus
    ...
    attr_accessor :step_execution_status_list
    ...
    def self.openapi_types
      {
        ...
        :'step_execution_status_list' => :'Array<RecoveryPlanJobStepExecutionStatus>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::RecoveryPlanJobPhaseExecutionStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::RecoveryPlanJobPhaseExecutionStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'step_execution_status_list')
        if (value = attributes[:'step_execution_status_list']).is_a?(Array)
          self.step_execution_status_list = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          step_execution_status_list == o.step_execution_status_list
    end
    ...
    def hash
      [status, percentage_complete, step_execution_status_list].hash
    end
