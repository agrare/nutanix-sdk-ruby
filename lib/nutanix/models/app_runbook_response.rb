...
module Nutanix
  ...
  class AppRunbookResponse
    ...
    def self.openapi_types
      {
        :'task_definition_list' => :'Array<AppTaskResponse>',
        :'description' => :'String',
        :'name' => :'String',
        :'state' => :'String',
        :'main_task_local_reference' => :'AppTaskReference',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::AppRunbookResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::AppRunbookResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
