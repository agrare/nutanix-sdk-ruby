...
module Nutanix
  # Service definition for Application
  class AppServiceResponseDownload
    ...
    def self.openapi_types
      {
        ...
        :'element_list' => :'Array<AppServiceElement>',
        :'depends_on_list' => :'Array<EntityReference>',
        :'name' => :'String',
        :'config_reference' => :'AppServiceReferenceUpload',
        :'state' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::AppServiceResponseDownload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::AppServiceResponseDownload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [singleton, uuid, action_list, element_list, depends_on_list, name, config_reference, state, port_list, editables, tier, container_spec, message_list, variable_list, description].hash
    end
