...
module Nutanix
  ...
  class DockerRegistryImageStatus
    # Owner user name
    attr_accessor :owner
    ...
    def self.openapi_types
      {
        :'owner' => :'String',
        :'is_official' => :'Boolean',
        :'tag_list' => :'Array<DockerRegistryImageTag>',
        :'description' => :'String',
        :'name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::DockerRegistryImageStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::DockerRegistryImageStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_official')
        self.is_official = attributes[:'is_official']
      else
        self.is_official = nil
      end
    ...
    def list_invalid_properties
      ...
      if @is_official.nil?
        invalid_properties.push('invalid value for "is_official", is_official cannot be nil.')
      end

      if @tag_list.nil?
        invalid_properties.push('invalid value for "tag_list", tag_list cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_official.nil?
      return false if @tag_list.nil?
    ...
    def hash
      [owner, is_official, tag_list, description, name].hash
    end
