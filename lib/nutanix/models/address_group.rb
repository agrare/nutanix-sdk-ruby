...
module Nutanix
  ...
  class AddressGroup
    ...
    attr_accessor :address_group_string

    attr_accessor :name

    # list of subnets and CIDR blocks in the address group
    attr_accessor :ip_address_block_list
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'ip_address_block_list' => :'Array<IpSubnet>',
        :'description' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::AddressGroup` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::AddressGroup`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'address_group_string')
        self.address_group_string = attributes[:'address_group_string']
      end
      ...
      if attributes.key?(:'ip_address_block_list')
        if (value = attributes[:'ip_address_block_list']).is_a?(Array)
          self.ip_address_block_list = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          address_group_string == o.address_group_string &&
          name == o.name &&
          ip_address_block_list == o.ip_address_block_list &&
    ...
    def hash
      [address_group_string, name, ip_address_block_list, description].hash
    end
