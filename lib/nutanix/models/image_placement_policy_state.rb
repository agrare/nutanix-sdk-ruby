...
module Nutanix
  ...
  class ImagePlacementPolicyState
    attr_accessor :policy_reference
    ...
    def self.openapi_types
      {
        ...
        :'policy_info' => :'ImagePlacementInfo',
        :'compliance_status' => :'String',
        :'enforcement_mode' => :'String',
        :'error_message_list' => :'Array<MessageResource>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::ImagePlacementPolicyState` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::ImagePlacementPolicyState`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'policy_reference')
        self.policy_reference = attributes[:'policy_reference']
      else
        self.policy_reference = nil
      end
    ...
    def list_invalid_properties
      ...
      if @policy_reference.nil?
        invalid_properties.push('invalid value for "policy_reference", policy_reference cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_reference.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          policy_reference == o.policy_reference &&
    ...
    def hash
      [policy_reference, policy_info, compliance_status, enforcement_mode, error_message_list].hash
    end
