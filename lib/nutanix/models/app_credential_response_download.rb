...
module Nutanix
  # Credential definition for Application
  class AppCredentialResponseDownload
    # 
    ...
    def self.openapi_types
      {
        ...
        :'state' => :'String',
        :'name' => :'String',
        :'secret' => :'Hash<String, Object>',
        :'editables' => :'Hash<String, Object>',
        :'type' => :'String',
        :'passphrase' => :'Hash<String, Object>',
        :'description' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::AppCredentialResponseDownload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::AppCredentialResponseDownload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'secret')
        if (value = attributes[:'secret']).is_a?(Hash)
          self.secret = value
        end
      else
        self.secret = nil
      ...
      if attributes.key?(:'passphrase')
        if (value = attributes[:'passphrase']).is_a?(Hash)
    ...
    def hash
      [username, uuid, message_list, state, name, secret, editables, type, passphrase, description].hash
    end
