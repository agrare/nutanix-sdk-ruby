...
module Nutanix
  ...
  class MhVmResourcesDefStatus
    # The hypervisor specific ID of the VM. 
    attr_accessor :hypervisor_specific_id
    ...
    def self.openapi_types
      {
        ...
        :'storage_config' => :'MhVmStorageConfigStatus',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::MhVmResourcesDefStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::MhVmResourcesDefStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'hypervisor_specific_id')
        self.hypervisor_specific_id = attributes[:'hypervisor_specific_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          hypervisor_specific_id == o.hypervisor_specific_id &&
    ...
    def hash
      [hypervisor_specific_id, host_reference, guest_tools, hypervisor_type, storage_config, protection_type, parent_reference, recovery_plan_state_list, protection_policy_state].hash
    end
