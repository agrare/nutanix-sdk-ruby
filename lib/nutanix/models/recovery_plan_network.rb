  ...
  class RecoveryPlanNetwork
    ...
    def self.openapi_types
      {
        ...
        :'use_vpc_reference' => :'Boolean',
        :'virtual_network_reference' => :'VirtualNetworkReference',
        :'subnet_list' => :'Array<RecoveryPlanSubnetConfig>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::RecoveryPlanNetwork` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::RecoveryPlanNetwork`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'use_vpc_reference')
        self.use_vpc_reference = attributes[:'use_vpc_reference']
      end
      ...
      if attributes.key?(:'subnet_list')
        if (value = attributes[:'subnet_list']).is_a?(Array)
          self.subnet_list = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          use_vpc_reference == o.use_vpc_reference &&
          virtual_network_reference == o.virtual_network_reference &&
          subnet_list == o.subnet_list
    end
    ...
    def hash
      [name, vpc_reference, use_vpc_reference, virtual_network_reference, subnet_list].hash
    end
