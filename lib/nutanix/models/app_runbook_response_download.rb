...
module Nutanix
  # Runbook definition for Application
  class AppRunbookResponseDownload
    # 
    attr_accessor :task_definition_list
    ...
    attr_accessor :main_task_local_reference
    ...
    def self.openapi_types
      {
        :'task_definition_list' => :'Array<AppTaskResponseDownload>',
        :'description' => :'String',
        :'name' => :'String',
        :'state' => :'String',
        :'main_task_local_reference' => :'AppTaskReferenceUpload',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::AppRunbookResponseDownload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::AppRunbookResponseDownload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'task_definition_list')
        if (value = attributes[:'task_definition_list']).is_a?(Array)
          self.task_definition_list = value
        end
      end
      ...
      if attributes.key?(:'main_task_local_reference')
        self.main_task_local_reference = attributes[:'main_task_local_reference']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          task_definition_list == o.task_definition_list &&
          description == o.description &&
          name == o.name &&
          state == o.state &&
          main_task_local_reference == o.main_task_local_reference &&
    ...
    def hash
      [task_definition_list, description, name, state, main_task_local_reference, message_list, variable_list, uuid].hash
    end
