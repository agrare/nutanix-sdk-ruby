...
module Nutanix
  ...
  class VmBootConfig
    ...
    attr_accessor :boot_device_order_list
    ...
    def self.openapi_types
      {
        :'boot_device_order_list' => :'Array<String>',
        :'boot_device' => :'VmBootDevice',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::VmBootConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::VmBootConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'boot_device_order_list')
        if (value = attributes[:'boot_device_order_list']).is_a?(Array)
          self.boot_device_order_list = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          boot_device_order_list == o.boot_device_order_list &&
    ...
    def hash
      [boot_device_order_list, boot_device, data_source_reference, boot_type].hash
    end
