...
module Nutanix
  # IPSEC related configuration status for the VPN connections.
  class IpsecConfigStatus
    # Virtual tunnel interface IP of the remote VPN gateway.
    attr_accessor :remote_vti_ip

    attr_accessor :negotiated_proposal
    ...
    def self.openapi_types
      {
        ...
        :'negotiated_proposal' => :'IpsecConfigStatusNegotiatedProposal',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::IpsecConfigStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::IpsecConfigStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'negotiated_proposal')
        self.negotiated_proposal = attributes[:'negotiated_proposal']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          negotiated_proposal == o.negotiated_proposal &&
    ...
    def hash
      [remote_vti_ip, negotiated_proposal, remote_authentication_id, local_vti_ip, ike_lifetime_secs, esp_pfs_dh_group_number, local_authentication_id, ipsec_lifetime_secs, vti_ip_prefix_length, pre_shared_key].hash
    end
