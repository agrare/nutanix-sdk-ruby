...
module Nutanix
  ...
  class AppProfileResponseDownload
    # 
    ...
    def self.openapi_types
      {
        :'deployment_create_list' => :'Array<BlueprintDeploymentResponseDownload>',
        :'description' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nutanix::AppProfileResponseDownload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nutanix::AppProfileResponseDownload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @dependency_list.nil?
        invalid_properties.push('invalid value for "dependency_list", dependency_list cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dependency_list.nil?
    ...
    def hash
      [deployment_create_list, description, action_list, name, state, editables, message_list, dependency_list, variable_list, uuid].hash
    end
