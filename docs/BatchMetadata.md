# Nutanix::BatchMetadata

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **last_update_time** | **Time** | UTC date and time in RFC-3339 format when batch was last updated  | [optional][readonly] |
...
| **creation_time** | **Time** | UTC date and time in RFC-3339 format when batch was created  | [optional][readonly] |
...
| **categories_mapping** | **Hash&lt;String, Array&lt;String&gt;&gt;** | Categories for the batch. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories.  | [optional] |
...
| **categories** | **Hash&lt;String, String&gt;** | Categories for the batch. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field.  | [optional] |
...
instance = Nutanix::BatchMetadata.new(
